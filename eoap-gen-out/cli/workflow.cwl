...
- id: s2_search
  ...
  - id: months
  run: 
    /home/runner/work/user-workflows/user-workflows/eoap-gen-out/cli/s2_search/s2_search.cwl
- id: s2_rm_cloud
  in:
  - id: item_url
  ...
  - id: cloud_masked
  run: 
    /home/runner/work/user-workflows/user-workflows/eoap-gen-out/cli/s2_rm_cloud/s2_rm_cloud.cwl
  scatter:
  - item_url
...
- id: s2_mosaic
  ...
  - id: best_pixel
  run: 
    /home/runner/work/user-workflows/user-workflows/eoap-gen-out/cli/s2_mosaic/s2_mosaic.cwl
  scatter:
  - month_json
  scatterMethod: dotproduct
- id: s2_make_stac
  ...
  - id: stac_catalog
  run: 
    /home/runner/work/user-workflows/user-workflows/eoap-gen-out/cli/s2_make_stac/s2_make_stac.cwl
